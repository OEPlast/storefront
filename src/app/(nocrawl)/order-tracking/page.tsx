...
// Robots come from the (nocrawl) group layout: getDefaultMetadata() would otherwise return
// `index, follow` on production, and leaving `robots` unset here lets that inherit instead.
