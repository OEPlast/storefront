...
const ContactSection: React.FC<ContactSectionProps> = ({
    ...
    return (
        <CollapsibleSection
            ...
            icon={<Icon.User size={24} weight="duotone" className="text-blue-600" />}
            isExpanded
            onToggle={noop}
            hideToggle
            className={className}
            ...
            {isSessionLoading ? (
                ...
                <div className="flex items-center gap-3 border border-line rounded-lg px-4 py-3">
                    ...
                    <div className="min-w-0">
                        ...
                        {userName ? (
                            <div className="caption1 text-secondary truncate mt-0.5">{userName}</div>
                        ) : null}
                    </div>
                    <Icon.CheckCircle
                        size={20}
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div className="caption1 text-secondary mt-1">
                                An account is required to place this order. We&apos;ll send your
                                confirmation and receipt to your account email.
                            </div>
                        </div>
                    </div>
